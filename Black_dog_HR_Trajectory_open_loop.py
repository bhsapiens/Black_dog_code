...
# Roll Pitch Yaw
print ("Inititiating Black Dog open loop")
...
while 1:
    ...
    if Leg_no == 5:
	mn = 100
	print("Motor name (PWM number): FLK(0) FLH(1) FLA(2) FRA(3) FRH(4) FRK(5) HLH(6) HLK(7) HLA(8) HRA(9) HRK(10) HRH(11)")
	...
	flag = 0
		...
		print("I can do squats (0), trot (1), bound (2), Amber (3), walk (4), stand (5), couch(6), sit(7), sit to stand(8)")
		V_type = input(" Please input the motion (number) you wish me to demonstrate: ")
			...
			if V_type == 8: H0 = input("Please enter sitting heigth (min: -0.05, max: -0.15) : ")
			if H0 > 0: H0 = -H0
		else:
			T_run = 1000
